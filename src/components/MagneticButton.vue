...
import MagneticButton from '/src/scripts/MagneticButton'

export default {

    mounted() {
        const button = new MagneticButton(this.$refs.button, this.$refs.star);
    },
